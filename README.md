...
This project is supported by a grant from [Golem Factory](https://golem.network). Golem's support has been instrumental in building the peer-to-peer mentorship platform, the learning quest engine, and the proof-of-skill system.
