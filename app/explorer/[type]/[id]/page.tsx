...
export default function EntityDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchEntity = async () => {
      ...
      try {
        const endpoint =
          type === 'profile' ? `/api/explorer/profile/${id}` : `/api/explorer/${type}/${id}`;
  ...
  const getHumanTitle = () => {
    ...
    if (entity.type === 'offer' && 'message' in entity) {
      ...
      return (
        entity.title || `Offer: ${offer.skill || offer.skill_label || 'Unknown'}` || 'Unknown Offer'
      );
    }
    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="mb-4">
            <PageHeader title={getHumanTitle()} description={entity.summary} />
            {/* View on Arkiv link */}
            <div className="mt-3">
              <ViewOnArkivLink
            ...
            <>
              ...
              {entity.type === 'profile' && (
                <div className="mt-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/50">
                        ...
                        <code className="break-all text-sm text-gray-900 dark:text-gray-100">
                          {entity.key}
                        </code>
                      </div>
                      {entity.wallet && (
                  ...
                  {(entity as any).contactLinks &&
                    Object.keys((entity as any).contactLinks).length > 0 && (
                      <div>
                        <h3 className="mb-3 text-lg font-semibold text-gray-900 dark:text-gray-100">
                          Contact Links
                        </h3>
                          ...
                          <div className="flex flex-wrap gap-3">
                            {(entity as any).contactLinks.twitter && (
                              <a
                                ...
                                className="inline-flex items-center gap-2 rounded-lg bg-blue-100 px-3 py-2 text-blue-700 transition-colors hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50"
                              >
                            ...
                            {(entity as any).contactLinks.github && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-2 text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                              >
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {(entity as any).contactLinks.discord && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 rounded-lg bg-indigo-100 px-3 py-2 text-indigo-700 transition-colors hover:bg-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-300 dark:hover:bg-indigo-900/50"
                              >
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {((entity as any).skills ||
                    (entity as any).skillsArray ||
                    (entity as any).skillExpertise) && (
                    <div>
                      <h3 className="mb-3 text-lg font-semibold text-gray-900 dark:text-gray-100">
                        Skills
                      </h3>
                      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/50">
                          ...
                          <div className="mb-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {(entity as any).skillsArray.map((skill: string, idx: number) => (
                                <span
                                  key={idx}
                                  className="rounded bg-blue-100 px-2 py-1 text-sm text-blue-800 dark:bg-blue-900/30 dark:text-blue-200"
                                >
                                  {skill}
                                </span>
                              ))}
                        ...
                        {(entity as any).skillExpertise &&
                          Object.keys((entity as any).skillExpertise).length > 0 && (
                            <div>
                              <div className="mb-2 text-xs font-semibold text-gray-500 dark:text-gray-400">
                                Expertise Levels
                              </div>
                              <div className="space-y-1">
                                {Object.entries((entity as any).skillExpertise).map(
                                  ([skillId, level]: [string, any]) => (
                                    <div
                                      key={skillId}
                  ...
                  {/* Additional Fields */}
                  {((entity as any).languages ||
                    (entity as any).seniority ||
                    (entity as any).domainsOfInterest ||
                    (entity as any).mentorRoles ||
                    (entity as any).learnerRoles ||
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        {(entity as any).domainsOfInterest &&
                          (entity as any).domainsOfInterest.length > 0 && (
                            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/50">
                              <div className="mb-1 text-xs font-semibold text-gray-500 dark:text-gray-400">
                                Domains of Interest
                              </div>
                              <div className="text-sm text-gray-900 dark:text-gray-100">
                                {(entity as any).domainsOfInterest.join(', ')}
                              </div>
                            </div>
                          )}
                        {(entity as any).mentorRoles && (entity as any).mentorRoles.length > 0 && (
                          <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/50">
                            ...
                            <div className="text-sm text-gray-900 dark:text-gray-100">
                              {(entity as any).mentorRoles.join(', ')}
                            </div>
                          </div>
                        )}
                        {(entity as any).learnerRoles &&
                          (entity as any).learnerRoles.length > 0 && (
                            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/50">
                              <div className="mb-1 text-xs font-semibold text-gray-500 dark:text-gray-400">
                                Learner Roles
                              </div>
                              <div className="text-sm text-gray-900 dark:text-gray-100">
                                {(entity as any).learnerRoles.join(', ')}
                              </div>
                            </div>
                          )}
                      </div>
              ...
              {entity.provenance && (
                <div className="mt-8 border-t border-gray-200 pt-6 dark:border-gray-700">
                  <button
                    ...
                    className="flex w-full items-center justify-between text-left text-sm font-medium text-gray-600 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
                  >
                    ...
                    <svg
                      className={`h-4 w-4 transition-transform ${showProvenance ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <div className="mt-6 border-t border-gray-200 pt-6 dark:border-gray-700">
                <details className="group">
                  <summary className="-mx-2 mb-2 flex cursor-pointer items-center gap-2 rounded px-2 py-1 text-sm font-semibold text-gray-700 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-300 dark:hover:text-gray-100">
                    <svg
                  ...
                  <pre className="mt-2 overflow-auto rounded-lg border border-gray-200 bg-gray-50 p-4 font-mono text-xs dark:border-gray-700 dark:bg-gray-900">
          ...
          {activeTab === 'transactions' && <TransactionList type={type} id={id} />}
        </div>
      </div>
    </div>
  );
