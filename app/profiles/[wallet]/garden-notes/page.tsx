            ...
            {arkivBuilderMode ? (
              <ArkivQueryTooltip
                query={[
                  `loadNotes()`,
                  `Queries:`,
                  `1. GET /api/garden-notes?targetWallet=${wallet?.toLowerCase().slice(0, 8) || '...'}...`,
                  `   → type='garden_note', targetWallet='${wallet?.toLowerCase().slice(0, 8) || '...'}...'`,
                  `2. GET /api/garden-notes?authorWallet=${wallet?.toLowerCase().slice(0, 8) || '...'}...`,
