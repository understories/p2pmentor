  ...
  return (
    <div className="mb-8 overflow-visible">
      ...
      <div className="relative mb-4">
        ...
        <div
          className="absolute left-0 top-1/2 h-px w-8"
          style={{
            background:
              theme === 'dark'
          ...
          {skillProfiles.length > 0 && (
            <div className="ml-2 flex items-center gap-1">
              {skillProfiles.map((profile, idx) => (
                <div
                  key={profile.wallet}
                  className="flex h-6 w-6 items-center justify-center rounded-full border border-green-300/30 bg-gradient-to-br from-green-400/20 to-blue-500/20 dark:border-green-500/20 dark:from-green-400/10 dark:to-blue-500/10"
                  style={{
      ...
      {/* Cards */}
      <div className="space-y-3 overflow-visible pl-10">
        {/* Matches */}
        {matches.map((match) => {
          const matchCard = (
            <div
              key={`${match.ask.key}-${match.offer.key}`}
              className="cursor-pointer rounded-xl border-2 p-4 transition-all duration-200 hover:scale-[1.02]"
              onClick={() => onMatchClick?.(match)}
              style={{
                backgroundColor:
                  theme === 'dark' ? 'rgba(255, 200, 100, 0.1)' : 'rgba(255, 200, 100, 0.05)',
                borderColor:
                  theme === 'dark' ? 'rgba(255, 200, 100, 0.4)' : 'rgba(255, 200, 100, 0.3)',
                boxShadow:
                  theme === 'dark'
            ...
            >
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-gray-500 opacity-50 dark:text-gray-400">
                  Match made at: {formatDate(match.ask.createdAt)}
                </span>
              </div>
        ...
        {asks.map((ask) => {
          ...
          const askCard = (
            <div
              ...
              style={{
                backgroundColor:
                  theme === 'dark' ? 'rgba(34, 197, 94, 0.05)' : 'rgba(34, 197, 94, 0.03)',
                borderColor:
            ...
            >
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-green-300/30 bg-gradient-to-br from-green-400/20 to-blue-500/20 dark:border-green-500/20 dark:from-green-400/10 dark:to-blue-500/10">
                    <EmojiIdentitySeed profile={profile} size="sm" />
                  </div>
                </div>
                <div className="flex-1">
                  ...
                  {userWallet &&
                    userWallet.toLowerCase() !== ask.wallet.toLowerCase() &&
                    onOfferToHelpFromAsk &&
                    profile && (
                      <div className="mt-3">
                        <button
          ...
          const offerCard = (
            <div
              ...
              style={{
                ...
                borderColor:
                  theme === 'dark' ? 'rgba(34, 197, 94, 0.3)' : 'rgba(34, 197, 94, 0.25)',
                borderStyle: 'solid',
                boxShadow:
                  theme === 'dark'
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  {userWallet &&
                    userWallet.toLowerCase() !== offer.wallet.toLowerCase() &&
                    onRequestMeetingFromOffer &&
                    profile && (
                      <div className="mt-3">
                        <button
