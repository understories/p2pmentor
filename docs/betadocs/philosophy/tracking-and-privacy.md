...
Before picking charts, decide what's _allowed_:
...
5. **Everything explainable to the user**
   ...
   - If a user asks, you can point to a public doc: _"Here's exactly what metrics we track, where the data lives, and why."_
