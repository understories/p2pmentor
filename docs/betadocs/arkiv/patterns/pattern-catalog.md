...
Anything normative anywhere else must link here. No entity schema (`profile.md`, etc.) should introduce new rules—they may reference patterns only.
...
**Status:** ✅ Documented
**Location:** [`flows/session-state-machine.md`](../flows/session-state-machine.md)
