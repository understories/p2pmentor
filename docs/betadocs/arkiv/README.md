...
Navigation guide for Arkiv implementation in p2pmentor.
...
## If you are debugging production

1. **[Operations](/docs/arkiv/operations/README)** - How the system runs, what breaks, and who fixes it
2. **[Implementation FAQ](/docs/arkiv/operations/implementation-faq)** - Common questions and troubleshooting
...
- **`overview/`** - Conceptual primitives (non-normative, reader-first)
- **`patterns/`** - Theory of operation (single source of truth for rules)
