...
In this track, you'll learn to build decentralized applications with Arkiv. By the end, you'll be able to:

- Create entities (data records) on Arkiv
- Query and retrieve your data
- Verify your data on-chain using the Explorer
- Understand the "walkaway test" for data independence
...
- **Composable** - Multiple apps can read the same data
...
Click "Complete" below to mark this step as done and continue to the setup.
