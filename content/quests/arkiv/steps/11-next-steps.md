...
- **Error handling** - Transaction timeouts and retries
...
- **Task manager** - Tasks that persist forever
- **Portfolio tracker** - Verifiable investment records

### Join the Community

- **Arkiv Discord** - Get help and share projects
- **GitHub Discussions** - Ask questions
- **Documentation** - Deep dive into patterns
- **Examples** - See what others are building
...
Before earning your badge, take the knowledge check to verify your understanding. This ensures you've grasped the core concepts of building with Arkiv.
...
- Includes evidence refs to all completed steps
