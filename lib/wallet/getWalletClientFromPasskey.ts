 ...
 * ```
 */
export async function getWalletClientFromPasskey(userId: string, credentialID: string) {
  ...
  console.log(
    '[getWalletClientFromPasskey] Creating Arkiv wallet client (same pattern as MetaMask)...'
  );
