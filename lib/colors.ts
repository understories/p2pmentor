...
export const askColors = {
  ...
  // Buttons
  button:
    'bg-ask-accent hover:bg-ask-accent/90 text-white dark:bg-ask-accent-dark dark:hover:bg-ask-accent-dark/90',
  buttonOutline:
    'border-ask-accent text-ask-accent hover:bg-ask-primary dark:border-ask-accent-dark dark:text-ask-accent-dark dark:hover:bg-ask-primary-dark',
...
export const offerColors = {
  ...
  // Buttons
  button:
    'bg-offer-accent hover:bg-offer-accent/90 text-white dark:bg-offer-accent-dark dark:hover:bg-offer-accent-dark/90',
  buttonOutline:
    'border-offer-accent text-offer-accent hover:bg-offer-primary dark:border-offer-accent-dark dark:text-offer-accent-dark dark:hover:bg-offer-primary-dark',

  // Badges/status
  badge:
    'bg-offer-primary text-offer-accent dark:bg-offer-primary-dark dark:text-offer-accent-dark',
