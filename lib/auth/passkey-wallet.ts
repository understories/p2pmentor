 ...
 */
async function deriveEncryptionKey(credentialID: string, userId: string): Promise<CryptoKey> {
 ...
 */
export async function loadEncryptedWallet(userId: string): Promise<EncryptedPayload | undefined> {
